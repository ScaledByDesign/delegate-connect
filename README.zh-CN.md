...
provider；当前 OSS catalog 已适配 643+ 个 provider，后续会随着工程迁移持续把更多集成整理成可维护的开源
...
| [oomol](https://oomol.com/) | 被 OAuth 申请周期或上线时间卡住的团队 | 托管鉴权、运行时和 1,000+ provider catalog，并保留后续迁移到私有化或自托管部署的空间 |
